...
# * A common source file, "webget.sh", developed for making other scraper scripts.
...
# TODO: Write version 5 in Ruby.
# TODO: Multi-download
# TODO:  -a to append two gallery links sequentially.
# TODO: space separate gallery strings at prompt
